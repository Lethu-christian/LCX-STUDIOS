            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="p-8 rounded-3xl bg-slate-950 border border-white/10 text-center shadow-xl">
                            ...
                            <button
                                ...
                                className="w-full py-3 rounded-xl bg-slate-950/5 border border-white/10 text-red-400 font-semibold flex items-center justify-center gap-2 hover:bg-red-500/10 hover:border-red-500/20 transition-all"
                            >
                                <LogOut size={18} />
                                Log Out
                            </button>
                        </div>
                        <div className="p-6 rounded-2xl bg-slate-950 border border-white/10 shadow-sm">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <div className="p-8 rounded-3xl bg-[#020617]/50 border border-white/10 backdrop-blur-md">
                            ...
                            <div className="text-center py-12 px-6 rounded-2xl bg-slate-900 border border-dashed border-white/10 text-slate-500">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <button className="p-6 rounded-2xl bg-slate-900 border border-white/10 text-left hover:bg-slate-800 transition-all">
