            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="p-8 rounded-3xl bg-slate-900 border border-slate-600 text-center shadow-xl">
                            ...
                            <button
                                ...
                                className="w-full py-3 rounded-xl bg-slate-900/5 border border-slate-600 text-red-400 font-semibold flex items-center justify-center gap-2 hover:bg-red-500/10 hover:border-red-500/20 transition-all"
                            >
                                <LogOut size={18} />
                                Log Out
                            </button>
                        </div>
                        <div className="p-6 rounded-2xl bg-slate-900 border border-slate-600 shadow-sm">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="flex justify-between text-slate-400">
                                    ...
                                    <span className="text-white">{profile.lastSignIn}</span>
                                </div>
                                <div className="flex justify-between text-slate-400">
                                    <span>Status</span>
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <div className="p-8 rounded-3xl bg-[#020617]/50 border border-slate-600 backdrop-blur-md">
                            ...
                            <div className="text-center py-12 px-6 rounded-2xl bg-slate-900 border border-dashed border-slate-600 text-slate-400">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <button className="p-6 rounded-2xl bg-slate-900 border border-slate-600 text-left hover:bg-slate-800 transition-all">
                                <h4 className="text-white font-bold mb-1">Billing History</h4>
                                <p className="text-slate-400 text-xs">Manage your invoices</p>
                            </button>
                            <button className="p-6 rounded-2xl bg-slate-900 border border-slate-600 text-left hover:bg-slate-800 transition-all">
                                <h4 className="text-white font-bold mb-1">Project Files</h4>
                                <p className="text-slate-400 text-xs">Access your deliverables</p>
                            </button>
                        </div>
                    </div>
                </motion.div>
                ...
                <button
                    onClick={onBack}
                    className="mt-12 inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors"
                >
                    <ArrowLeft size={18} />
                    Back to Home
                </button>
