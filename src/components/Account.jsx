            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="p-8 rounded-3xl bg-slate-900/50 border border-white/10 backdrop-blur-md text-center">
                            <div className="relative inline-block mb-6">
                                ...
                                <div className="absolute bottom-0 right-0 p-2 rounded-full bg-blue-600 border-2 border-slate-900 text-white">
                                    <Shield size={16} />
                                </div>
                            </div>
                        ...
                        <div className="p-6 rounded-2xl bg-slate-900/30 border border-white/5">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between text-slate-400">
                                    <span>Joined</span>
                                    <span className="text-slate-200">{profile.joined}</span>
                                </div>
                                <div className="flex justify-between text-slate-400">
                                    <span>Last Login</span>
                                    <span className="text-slate-200">{profile.lastSignIn}</span>
                                </div>
                                <div className="flex justify-between text-slate-400">
                                    <span>Status</span>
                    ...
                    <div className="md:col-span-2 space-y-8">
                        <div className="p-8 rounded-3xl bg-slate-900/50 border border-white/10 backdrop-blur-md">
                            ...
                            <div className="text-center py-12 px-6 rounded-2xl bg-white/5 border border-dashed border-white/10 text-slate-500">
